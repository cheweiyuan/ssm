...
<div class="page-header">
    <h1>注册账号</h1>
    <h1 style="color : red;"><%=request.getParameter("registerInfo") == null ? "" : request.getParameter("registerInfo")  %>
    </h1>
</div>
<form id="user" action="${pageContext.request.contextPath}/user/register" method="post">
    ...
    &nbsp;&nbsp;&nbsp;
    <button type="button" onclick="location.href = '${pageContext.request.contextPath}/'" class="btn btn-success">跳转登录
    </button>
</form>
</body>
